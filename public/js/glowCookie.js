  ...
  clearCookies() {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      for (; t.length > 0; ) {
        ...
        for (document.cookie = i + "/"; o.length > 0; )
          (document.cookie = i + o.join("/")), o.pop();
        t.shift();
      }
    }
  }
      ...
      this.tracking.customScript.forEach((n) => {
        "src" === n.type
          ? ((e = document.createElement("script")),
            e.setAttribute("src", n.content))
          : "custom" === n.type &&
            ((e = document.createElement("script")), (e.text = n.content)),
          "head" === n.position
            ? document.head.appendChild(e)
  ...
  init() {
    this.arrLang = {
      ...
      ca: {
        ...
        bannerDescription:
          "Utilitzem cookies pròpies i de tercers per a personalitzar el contingut i per a analitzar el trànsit del lloc web.",
